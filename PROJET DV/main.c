...
void afficher_menu() {
    ...
    printf("\033[32m7\033[0m. Etude des niveaux trophiques\n");
    printf("\033[32m8\033[0m. Recherche des chaines alimentaires\n");
    printf("\033[32m9\033[0m. Calculer la centralite_int des especes\n");
    printf("\033[32m10\033[0m. Simuler la disparition d'une espece\n");
    printf("\033[32m11\033[0m. Restaurer l'espece supprimee\n");
    printf("\033[32m12\033[0m. Simulation de la dynamique des populations\n");
    printf("\033[32m13\033[0m. Quitter\n");
}
...
int main() {
    ...
    do {
        ...
        switch (choix) {
            ...
            case 7: {
                printf("\033[32mOption 7 choisie : Etude des niveaux trophiques.\n\033[0m");
            ...
            case 8: {
                printf("\033[32mOption 12 choisie : Recherche des chaînes alimentaires.\n\033[0m");
                char start_species[MAX_NAME_LENGTH];
                printf("\033[36mEntrez le nom de l'espece de depart : \033[0m");
                scanf("%s", start_species);
                find_food_chains(n, especes, matrice_adjacence, start_species);
                break;
            }
